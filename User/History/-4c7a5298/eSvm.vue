...
<script lang="ts" setup>
  ...
  console.log('%c [  ]-55', 'font-size:13px; background:#0095FF; color:white;', attrs)
</script>
...
<template>
  <div class="enforce-account-home">
    ...
    <n-card :bordered="false">
      <component :is="pageVariable.currentComp" :programType="pageVariable.currentProgramType" v-bind="attrs" :useSelector="useSelector" />
    </n-card>
  </div>
</template>
