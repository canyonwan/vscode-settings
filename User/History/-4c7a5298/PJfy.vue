...
<script lang="ts" setup>
  ...
  // 当选中提交时
  function submitHandler(row: IProgramItem) {
    emit('selectedRowHandler', row)
  }
...
<template>
  <div class="enforce-account-home">
    ...
    <n-card :bordered="false">
      <component :is="pageVariable.currentComp" :programType="pageVariable.currentProgramType" :useSelector="useSelector" @selectedRowHandler="submitHandler" />
    </n-card>
  </div>
</template>
