<script setup lang="ts">
  ...
  watch(
    () => props.causeTagIds,
    () => {
      console.log('%c [ props.causeTagIds ]-158', 'font-size:13px; background:#0095FF; color:white;', props.causeTagIds)
...
<template>
  <div class="unlawful-act px-3 flex items-center justify-center">
    <n-spin :show="loading">
