...
<template>
  <div class="legal-knowledge-examination-training">
    ...
    <a-card hoverable style="margin: 20px 0">
      ...
      <a-table
        :rowClassName="(record: any, index ) => (index % 2 === 1 ? 'table-striped' : null)"
      ...
      >
        ...
        <template #action="{ record }" v-if="user.isJustice">
    ...
    const state = reactive({
      ...
      columns: [
        ...
        },
        {
          ...
          width: 140,
          slots: { customRender: 'nowStudyDuration' }
        },
        {
          title: '考试成绩',
