...
export const tableColumns = [
  ...
  },
  {
    ...
    width: 200,
    filterOptionValue: '1000003',
    filter: (value, row: IEvidenceGroupType) => {
      console.log('%c [ value ]-22', 'font-size:13px; background:#0095FF; color:white;', value)
      // return !!~row.evidenceRuleTypeId.indexOf(value.toString())
      return row.evidenceRuleTypeId === value
    }
  },
  {
    title: '备注',
