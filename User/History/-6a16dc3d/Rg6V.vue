<script setup lang="ts">
  ...
  function onUpdateBaseValue(value: number) {
    console.log('%c [ value ]-90', 'font-size:13px; background:pink; color:#0095FF;', value)
    discretionBaseState.baseValue = value
    console.log('%c [ discretionBaseState.baseValue ]-90', 'font-size:13px; background:pink; color:#0095FF;', discretionBaseState.baseValue)
  }
