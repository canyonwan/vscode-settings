<script setup lang="ts">
  ...
  import { sponsorOptions, createColumns, type ITaskSources } from './relate-task-options'
...
<template>
  <div class="relate-task">
    <n-space>
      <n-select style="width: 180px" v-model:value="searchParams.taskStage" :options="sources.taskStage" />
