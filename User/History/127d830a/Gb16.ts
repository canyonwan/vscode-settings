...
const PrimaryCause = defineAsyncComponent(() => import('@/views/cause-library/manage/components/primary-cause'))
const SubCause = defineAsyncComponent(() => import('@/views/cause-library/manage/components/sub-cause.vue'))
const SaveHandlingWay = defineAsyncComponent(() => import('@/views/cause-library/manage/components/save-handling-way'))
// const SaveGroup = defineAsyncComponent(() => import('@/views/cause-library/manage/components/save-group'))
const SaveGroup = defineAsyncComponent(() => import('@/views/cause-library/manage/components/save-group.vue'))
const GroupDetailTabs = defineAsyncComponent(() => import('@/views/cause-library/manage/components/group-details/group-detail-tabs'))
const OrgSelect = defineAsyncComponent(() => import('@/views/user/org-manage/components/org-select.vue'))
const SaveBaseAttrModal = defineAsyncComponent(() => import('@/views/cause-library/manage/components/group-details/base-attr/save-base-attr'))
