  ...
  <div class="document-mark rounded-tl-3xl px-5 py-3">
    ...
    <div class="content">
      <n-grid :cols="Object.keys(caseInfo).length ? 8 : 20" :x-gap="48" :style="{ height: 'calc(100vh - ' + 185 + 'px)' }">
        ...
        <n-gi v-else :span="10">
          <n-scrollbar :style="{ height: 'calc(100vh - ' + 185 + 'px)' }" class="pr-3">
            <DataPackage :program-id="caseParams.procedureId" />
          </n-scrollbar>
        </n-gi>
...
<script lang="ts">
  ...
  import DataPackage from '@/views/program/document-mark/components/data-package/index.vue'
