  ...
  <div class="document-mark rounded-tl-3xl px-5 py-3">
    ...
    <div class="content">
      <n-grid :cols="Object.keys(caseInfo).length ? 8 : 20" :x-gap="48" :style="{ height: 'calc(100vh - ' + 185 + 'px)' }">
        <n-gi :span="8">
          <n-button type="primary" size="medium" @click="">资料包</n-button>
  ...
  export default defineComponent({
    ...
    setup(props, context) {
      ...
      const makeDocument = async (toolInfo) => {
        ...
        console.log('%c [ currentToolInfo.value ]-127', 'font-size:13px; background:#0095FF; color:white;', currentToolInfo.value)
      }
