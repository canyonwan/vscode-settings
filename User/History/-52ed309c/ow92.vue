...
<template>
  <div class="inspect">
    ...
    <basic-table :row-key="(row: IProgramItem) => row.id" :request="loadTableData" ref="tableRef" :columns="inspectColumns" :action-column="actionColumn" scroll-x="1090" :single-line="true" />
