  ...
  <div class="cause-manage overflow-scroll">
    ...
    <n-card>
      <n-grid x-gap="12" :cols="4" :y-gap="40">
        ...
        <n-gi span="2">
          <n-space justify="space-between">
            <n-button class="mb-4" type="primary" @click="openSelectCauseTagsModal">选择案由标签</n-button>
...
<script lang="ts">
  ...
  import useDynamicComp from '@/views/cause-library/manage/outdated/options'
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const causeTagTreeState = reactive({
        causeTagTrees: [] as ILawTagType[], // 案由标签树
