...
export default defineComponent({
  ...
  setup(props) {
    ...
    function processData() {
      console.log('%c [ before actions ]-107', 'font-size:13px; background:#0095FF; color:white;', actions)
      ...
      console.log('%c [ after actions ]-107', 'font-size:13px; background:#0095FF; color:white;', actions)
    }
