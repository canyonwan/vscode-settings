...
export const createColumns = ({ sendMail, allowSelect }: { sendMail: (values: string[], pId: string) => void; allowSelect: boolean }): DataTableColumns<RowData> => {
  return [
    {
      title: '案由编号',
      key: 'identifier',
            ...
            {},
            {
              default: () => {
                return [
                  ...
                  h(
                    NCheckboxGroup,
                    { onUpdateValue: (values: string[]) => sendMail(values, row.identifier) },
