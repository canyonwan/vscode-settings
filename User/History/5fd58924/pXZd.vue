<template>
  <div class="tree-select">
    <n-tree-select :value="state.selectId" filterable :options="state.goodsCates" key-field="id" label-field="name" children-field="childrenList" clearable @update:value="onUpdateValue" />
  </div>
</template>
