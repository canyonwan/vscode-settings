<template>
  <div class="tree-select">
    <n-tree-select v-model:value="state.selectId" filterable :options="state.goodsCates" key-field="id" label-field="name" children-field="childrenList" clearable @update:value="onUpdateValue" />
  </div>
</template>
...
<script setup lang="ts">
  ...
  watch(
    () => props.selectedId,
    () => {
      state.selectId = props.selectedId
    }
  )
