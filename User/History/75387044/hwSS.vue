<template>
  <div class="flex flex-col justify-around">
    <n-menu
      ...
      :class="{ 'pr-4': !collapsed }"
      class="pb-10"
    />

    <div v-if="!collapsed" class="fixed bottom-10 w-2/3 ml-6 mt-10">
      <n-button secondary strong class="" @click="pushToWaste">
        <template #icon>
          <n-icon>
            <Trash />
          </n-icon>
    ...
    <div v-else class="fixed bottom-10 w-2/3 ml-6 mt-10">
      <n-button v-if="!collapsed" tertiary circle type="error" class="ml-4 mt-10" @click="pushToWaste">
        <template #icon>
          <n-icon><Trash /></n-icon>
        </template>
        回收站
    ...
    <!-- <n-button v-else tertiary circle type="error" class="ml-4 mt-10" @click="pushToWaste"> -->
    <!-- <template #icon>
        <n-icon><Trash /></n-icon>
      </template>
    </n-button> -->
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup(props, { emit }) {
      ...
      function pushToWaste() {
        router.replace({ path: '/waste' })
      }
