...
<template>
  <div class="message">
    <basic-table :request="loadTableData" :row-key="(row: IMessageItem) => row.newsId" ref="tableRef" :columns="messageColumn" :action-column="actionColumn" scroll-x="1090" single-line single-column>
      <template #toolbar>
        <n-button type="success">发送消息</n-button>
      </template>
    </basic-table>
