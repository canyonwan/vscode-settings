<template>
  <div class="table-toolbar">
    ...
    <div class="flex items-center table-toolbar-left">
      ...
      <slot name="tableTitle" v-if="buttonShowPermission(frontEndIdentification)" :disabled="buttonDisabledPermission(frontEndIdentification)"></slot>
    </div>

    <div class="flex items-center table-toolbar-right">
      <!--顶部右侧区域-->
      <slot name="toolbar" v-if="buttonShowPermission(frontEndIdentification)" :disabled="buttonDisabledPermission(frontEndIdentification)"></slot>
  ...
  <div class="s-table">
    <n-data-table ref="tableElRef" v-bind="getBindValues" :pagination="pagination" @update:page="updatePage" @update:page-size="updatePageSize">
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    emits: ['getPaginationInfo', 'fetch-success', 'fetch-error', 'update:checked-row-keys', 'edit-end', 'edit-cancel', 'edit-row-end', 'edit-change'],
    setup(props, { emit }) {
      ...
      const { getDataSourceRef, getRowKey, reload, getDataSource } = useDataSource(
        getProps,
        {
          getPaginationInfo,
          setPagination,
      ...
      function updatePage(page) {
        ...
        emit('getPaginationInfo', pagination)
        reload()
      }
      ...
      const getBindValues = computed(() => {
        ...
        const maxHeight = tableData.length || props.isFixedHeight ? `${unref(deviceHeight)}px` : 'auto'
        return {
          ...unref(getProps),
          striped: false,
          bordered: false,
          ...
          'min-height': props.isFixedHeight ? maxHeight : ''
        }
      })
