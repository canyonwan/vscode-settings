  ...
  <div class="form-home">
    <n-card :bordered="false">
      <n-alert type="info" closable class="mb-10">
        {{ rowData ? `正在${handleTargetData.editMode ? '编辑' : '新增'} 【${handleTargetData.handleTarget}】` : '请从左侧选择需要操作的对象' }}
      </n-alert>
...
<script lang="ts">
  ...
  import type { IHomeState } from '../index.vue'
  ...
  export default defineComponent({
    ...
    setup(_, { emit }) {
      ...
      const resetRowData = inject<() => void>('resetRowData')!
