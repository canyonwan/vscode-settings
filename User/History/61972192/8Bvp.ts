...
import { punishProgramType, StageTypeEnum } from '@/views/cause-browse/components/options'
...
const punishSchemas = <FormSchema[]>[
  ...
  },
  {
    ...
    componentDataSourceType: 'CaseType',
    label: '处罚方式',
    componentProps: {
      placeholder: '请选择处罚方式',
      checkStrategy: 'child',
  ...
  },
  {
    ...
    componentDataSourceEnumPrefix: 'reconsider',
    componentDataSourceName: 'ToolButtonSelectEnum',
    componentDataSourceType: 'EnumsType',
    componentProps: {
      placeholder: '请选择复议结果',
      clearable: true,
  ...
  },
  {
    ...
    component: 'NSelect',
    label: '诉讼结果',
    componentDataSourceName: 'StageType',
    componentDataSourceEnumPrefix: 'litigation',
    componentDataSourceType: 'EnumsType',
