  ...
  <div class="training-record">
    <a-row>
      <a-form-item label="培训年份">
        <a-date-picker picker="year" v-model:value="currentYear" @panelChange="panelChangeOne" placeholder="请选择年份" format="YYYY" />
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const getData = () => {
      console.log('%c [  ]-180', 'font-size:13px; background:#0095FF; color:white;', getData)
    }
    // 报名记录
