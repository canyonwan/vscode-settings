  ...
  watch(
    ...
    () => {
      if (props.useCheck) {
        ...
        console.log('%c [ props ]-82', 'font-size:13px; background:#0095FF; color:white;', props)
        console.log('%c [ props.checkedKeys ]-82', 'font-size:13px; background:#0095FF; color:white;', props.checkedKeys)
      }
    },
    {
      immediate: true
