...
<template>
  <div class="cause-type">
    ...
    <n-tree block-line key-field="id" label-field="name" :data="dataSources" :render-suffix="useCheck ? () => [] : renderSuffix" :checkable="useCheck" virtual-scroll style="height: 420px" />
