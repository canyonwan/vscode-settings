...
<template>
  <div class="cause-type">
    <n-button class="float-right mb-4" v-if="!useCheck && buttonShowPermission(['b08_01_01'])" @click="onAdd" type="success" :disabled="buttonDisabledPermission(['b08_01_01'])"> 新增 </n-button>
