<template>
  <div class="target-info">
    ...
    <div class="flex justify-end items-end mt-2" v-if="isSelection">
      <n-button class="ml-2" @click="onCloseModal">取消</n-button>
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    emits: ['update:selectTargets', 'cancelModal'],
    setup(props, context) {
      ...
      const [modalRegister, { openModal, onCloseModal, setSubLoading }] = useModal({})
      watch(
        () => props.rootTypeId,
        () => {
