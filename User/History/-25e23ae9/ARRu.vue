<script setup lang="ts">
  ...
  function handleSubmit(customDiscretionRes: IDiscretionMenuItem) {
    console.log('handleSubmit', customDiscretionRes)
...
<template>
  <div class="discretion-menu">
    <div v-for="item in discretionDetailList" :key="item.id">
      ...
      <n-button strong secondary size="small" type="error" @click="onDeleteCustomDiscretion">删除</n-button>
    </div>
    <!-- 自定义裁量 -->
    <div class="custom-discretion">
      ...
      <div v-for="customItem in discretionCustomList" :key="customItem.id">
        <d-menu-item :item="customItem" :whetherCustom="true" @handleDeleteCustomDiscretion="handleDeleteCustomDiscretion" />
      </div>
    </div>
