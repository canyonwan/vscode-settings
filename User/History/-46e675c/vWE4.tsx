...
interface IState {
  ...
  boundEvidenceList: IEvidenceGroupType[]
  boundEvidenceListKeys: string[]
  evidenceGroupItem: IEvidenceGroupType
    ...
    return () => (
      <div class="mt-6 mb-6" style="min-height: 300px">
        {state.boundEvidenceList.length === 0 ? (
          <NEmpty description="没有已经绑定的证据分组" class="justify-center" style="min-height: 300px" />
        ) : (
          <>
