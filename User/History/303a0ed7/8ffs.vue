...
<template>
  <n-space>
    <div v-for="item in fileData" :key="item.fileId" class="rounded-md hover:ring-2 border p-1 info mr-1 mb-1 cursor-pointer hover:bg-gray-900" @click="onPreview(item.fileUrl, item.fileType)">
