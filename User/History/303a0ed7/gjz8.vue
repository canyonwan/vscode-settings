...
<template>
  <n-space>
    ...
    >
      ...
      <!-- TODO 查看附件mark  -->
      <!-- <div class="hover:bg-blue-purple-500 absolute top-0 left-0 right-0 text-red-500 bg-black h-full w-full">mark</div> -->
    </div>
    ...
    <n-modal v-model:show="showAllFilesModal" preset="card" title="文件浏览" :bordered="false" style="width: 80%">
      <FileBrowser :files="values" />
    </n-modal>
  </n-space>
</template>
