...
<template>
  <div class="announcement">
    <n-form inline :label-width="100" :model="searchParams" class="my-4" label-placement="left">
      ...
      <n-form-item label="是否已读" v-show="searchParams.queryType === 2">
        <n-select v-model:value="searchParams.whetherRead" :options="whetherReadOptions" clearable />
      </n-form-item>
