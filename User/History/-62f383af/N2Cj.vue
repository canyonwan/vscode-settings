<script setup lang="ts">
  ...
  const currentRowData = ref<IMessageItem>()
...
<template>
  <div class="announcement">
    ...
    <basic-modal @register="modalRegister" style="width: 70%">
      <component :is="currentComp" :query-type="queryType" :announcement-id="announcementId" :row-data="currentRowData" @handle-close="() => closeModal()" @handle-submit="handleSubmit" />
    </basic-modal>
  </div>
</template>
