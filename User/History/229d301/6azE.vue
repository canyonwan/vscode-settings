<script setup lang="ts">
  ...
  const props = defineProps({
    rubbish: {
      type: Array as PropType<IDeletedNodeItem[]>,
      default: () => []
    }
  })

  function onUpdateValue(values: number[]) {
    console.log('on update value', values)
  }
  console.log('props', props.rubbish)
</script>
<template>
  <div>
    <n-checkbox-group v-model:value="state.nodes" @update:value="onUpdateValue">
      <n-space vertical>
