 ...
 */
export async function handleNodeToolClick({ isToolBox, nodeToolInfo, procedureData, programId, programType }: ShowContentParam) {
  //工具箱
  if (isToolBox) {
    ...
    console.log('%c [ nodeToolInfo.toolType ]-144', 'font-size:13px; background:#0095FF; color:white;', nodeToolInfo.toolType)
