<template>
  <div class="add-base-types">
    <basic-form @register="register" @submit="onSubmit" submit-button-text="提交" @close-modal="() => $emit('cancelHandler')" />
  </div>
</template>
  ...
  export default defineComponent({
    ...
    setup(props, { emit }) {
      ...
      function onSubmit(values: IBaseType) {
        ...
        let params = { ...values, ...props.editRowInfo }
        debugger
      ...
      onMounted(() => {
        ...
        props.editRowInfo?.id && setFieldsValue(props.editRowInfo)
      })
