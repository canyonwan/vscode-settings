...
<template>
  <div class="file-browser">
    ...
    <!-- 缩略图 -->
    <swiper @swiper="setThumbsSwiper" :loop="true" :spaceBetween="10" :slidesPerView="4" :freeMode="true" :watchSlidesProgress="true" :modules="modules" class="mySwiper">
      <swiper-slide v-for="file in files" :key="file.fileId">
        <!-- <img v-if="file.fileType === (FileTypeEnum.Picture || FileTypeEnum.Pdf || FileTypeEnum.Word || FileTypeEnum.Video)" :src="file.thumbnailFileUrl" class="w-20 h-20" /> -->
