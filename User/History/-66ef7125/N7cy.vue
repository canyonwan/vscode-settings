...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup(props, { emit }) {
      ...
      function updateCheckRowKeys(keys: string[], rows: IBaseType[]) {
      ...
      function submitSelectionHandler() {
        ...
        emit('selectedRowHandler', state.selectedRowKeys, state.selectedRow)
      }
      ...
      watch(
        ...
        () => {
          if (props.useSelection) {
            tableColumnsRef.value[2].edit = false
            ...
            tableColumnsRef.value[2].edit = true
            if (tableColumnsRef.value[0].type === 'selection') {
