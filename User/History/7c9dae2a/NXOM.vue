...
<template>
  <div class="inspect">
    ...
    <basic-table :row-key="(row: IProgramItem) => row.id" :request="loadTableData" ref="tableRef" :columns="inspectColumns" :action-column="useSelector ? null : actionColumn" scroll-x="1090" />
