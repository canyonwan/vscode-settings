<script setup lang="ts">
    ...
    const hasSelectedState = reactive({
  selectedTargets: []
  selectedPersonnels: []
    })
...
<template>
  <div class="inspect">
    ...
    <basic-modal @register="modalRegister" style="width: 70%">
      <component :is="currentModalContent" isSelection isMultiple @update:selectTargets="onUpdateSelectedTargets" :select-targets="selectTargets" @update:usersData="onUpdateSelectedEnforceMember" />
    </basic-modal>
  </div>
</template>
