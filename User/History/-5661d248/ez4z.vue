<script setup lang="ts">
  ...
  async function getTimelineList() {
    loading.value = true
    console.log('%c [ props.timelineId ]-36', 'font-size:13px; background:#0095FF; color:white;', props.timelineId)
  ...
  watch(
    ...
    () => {
      ...
      console.log('%c [ watch ]-69', 'font-size:13px; background:#0095FF; color:white;', 'watch: ', props.timelineId)
    }
  )
