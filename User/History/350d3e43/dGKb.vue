...
<script lang="ts" setup>
  ...
  const getThemeOverrides2 = computed(() => {
    ...
    return {
      ...
      Upload: {
        ...
        itemColorHover: 'rgba(82, 2, 255, 0.06)'
      },
      DataTable: {
        borderColor: '',
        tdColor: '#021C35'
  ...
  const getEnforceTheme = computed(() => (designStore.enforceTheme ? designStore.enforceTheme : designStore.darkTheme ? darkTheme : undefined))
