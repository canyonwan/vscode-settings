<script setup lang="ts">
  ...
  const bus = useEventBus('dispatchCurrentProgramType')
  bus.on((type: number) => {
    console.log('%c [ type ]-179', 'font-size:13px; background:#0095FF; color:white;', type)
    programType.value = type
  })
</script>
<template>
  <div class="case-detail">
    ...
    <n-space justify="space-between">
      <main-header :default-item="programType" @click-item-handler="clickItemHandler" />
