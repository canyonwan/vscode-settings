  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      watchEffect(() => {
        ...
        // 检查对象类型
        state.selectedCheckingTargetType = props.causeDetail?.penaltyObjectType ? props.causeDetail?.penaltyObjectType?.split(',') : props.causeDetail?.penaltyObjectType?.split(',') || []
        // 案由法
