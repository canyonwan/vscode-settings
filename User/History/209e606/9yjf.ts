...
export const schemas: FormSchema[] = [
  ...
  },
  {
    ...
    giProps: {},
    slot: 'customForm',
    rules: [{ required: true, message: '请输入罚没许可证编号', type: 'string', trigger: 'change' }]
  },
  {
    // TODO 罚没许可证编号照片
    field: '',
    ...
    label: '罚没许可证编号照片',
    giProps: {},
    rules: [{ required: true, message: '请上传罚没许可证编号照片', type: 'string', trigger: 'change' }]
  },
  {
    field: 'officePhone',
    giProps: {},
  ...
  // },
  {
    ...
    rules: [{ required: true, message: '请输入机关前缀', type: 'string', trigger: 'change' }]
  },
  {
    field: 'signature',
    giProps: {},
    ...
    rules: [{ required: true, message: '请输入执法文书落款', type: 'string', trigger: 'change' }]
  },
