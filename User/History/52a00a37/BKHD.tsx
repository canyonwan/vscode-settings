...
export default defineComponent({
  ...
  emits: ['okSaveEvidenceMenu', 'cancelModalHandler'],
  setup(props, { emit }) {
    ...
    return () => (
      // @close-modal="onCancelModal"
      <BasicForm onRegister={register} onSubmit={handleSubmit} onCloseModal={onCancelModal}>
        {{
