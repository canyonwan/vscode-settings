...
<template>
  <n-card class="discretion" ref="el">
    ...
    <div v-else>
      <n-tabs class="card-tabs" :default-value="causeListData?.at(0)?.id" size="large" animated style="margin: 0 -4px" pane-style="padding-left: 4px; padding-right: 4px; box-sizing: border-box;">
