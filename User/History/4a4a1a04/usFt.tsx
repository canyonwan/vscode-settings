    ...
    watch(
      ...
      () => {
        if (props.useSelection) {
          if (tableColumnOption.value[0].type !== 'selection') {
            console.log('%c [ value ]-181', 'font-size:13px; background:#0095FF; color:white;', tableRef.value)
            // tableRef.value.filter({
            //   evidenceRuleTypeId: ['1000003']
            // })
