            ...
            {{
              tableTitle: () => (
                <NSpace>
                  ...
                  <NSelect style="width: 200px" clearable placeholder="证据规则类型" options={state.evidenceRuleTypeSources} v-model:value={state.searchParams.evidenceRuleTypeId}></NSelect>
