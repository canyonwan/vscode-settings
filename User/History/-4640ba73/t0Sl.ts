...
import type { ICauseAttrItemType, ICauseManageSearchType, ICauseSubListItemType, IPrimaryCauseItemType, ISubCauseBaseAttrType } from '@/api/cause-manage/types'
 ...
 * @param params
 */
export function queryCauseManageList(params: ICauseManageSearchType): Promise<IResultPage<IPrimaryCauseItemType[]>> {
  return http.request({
