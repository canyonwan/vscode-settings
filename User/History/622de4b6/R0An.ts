...
import type { IGoodsCateItem, IGoodsCates, IGoodsItem, IGoodsPage } from './types'
 ...
 */
export function queryGoodsPageWithCate(data: { goodsTypeId: string; name?: string }): Promise<IResultPage<IGoodsPage>> {
