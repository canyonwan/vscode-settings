...
<script lang="ts">
import { value tabList } from '@/views/message-center/components/column-field'
import { value CloseCircleFilled, value PlusCircleOutlined } from '@ant-design/icons-vue'
import { value Tabs } from 'ant-design-vue'
import { value defineComponent, value nextTick, value reactive, value ref, value toRefs } from 'vue'
