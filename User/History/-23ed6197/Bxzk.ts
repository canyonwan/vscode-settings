...
import type { ITaskDetailBaseInfo, ITaskItem, ITaskTimeline } from './types'
 ...
 * @param params
 */
export function queryTaskDetailInTimeline(taskId: string): Promise<IResultPage<ITaskItem[]>> {
  return http.request({
 ...
 * @param params
 */
export function queryTaskDetailBaseInfo(taskId: string): Promise<ITaskTimeline> {
  return http.request({
