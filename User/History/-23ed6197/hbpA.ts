 ...
 * @param params
 */
export function queryTaskDetailInTimeline(taskId: string): Promise<ITaskTimeline> {
  return http.request({
 ...
 * @param params
 */
export function queryTaskDetailBaseInfo(taskId: string): Promise<ITaskDetailBaseInfo> {
  return http.request({
