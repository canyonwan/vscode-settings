...
<template>
  <div class="h-30">
    <div @click="onClick" ref="el" p="x-4 y-2" border="~ gray-400 rounded" shadow="~ hover:lg" class="fixed bg-$vt-c-bg select-none cursor-move z-10" style="touch-action: none" :style="style">
      👋 Drag me!
