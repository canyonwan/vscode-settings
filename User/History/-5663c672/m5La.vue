...
<script setup lang="ts">
  ...
  onBeforeRouteLeave((to) => {
    ...
    console.log('%c [ enteredRouterName.value ]-315', 'font-size:13px; background:#0095FF; color:white;', enteredRouterName.value)
    if (enteredRouterName.value === 'ProgramHome') stageBarBus.reset()
  })
