  ...
  <div class="discretion-tab-panel">
    ...
    <div class="bg-contentBgColor rounded-sm p-5">
      ...
      <div class="text-2xl text-blue-500">
        ...
        <n-number-animation class="text text-gray-500" ref="numberAnimationInstRef" show-separator :to="currentDiscretionResult?.discretionMoney" :precision="2" locale="ru-RU" /><span class="text-sm"
          >&nbsp;元</span
        ></div
      >
      <n-statistic label="处罚金额：" class="mt-2" tabular-nums>
        <template #suffix> <span class="text-sm">&nbsp;元</span> </template>
      </n-statistic>
      <keep-alive>
        <component
