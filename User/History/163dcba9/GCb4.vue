  ...
  <div class="discretion-tab-panel">
    ...
    <div class="bg-contentBgColor rounded-sm p-5">
      ...
      <n-ellipsis expand-trigger="click" line-clamp="2" :tooltip="false">
        ...
        <n-statistic label="自定义裁量结果：" tabular-nums>
          <n-number-animation ref="numberAnimationInstRef" show-separator :to="currentDiscretionResult?.discretionMoney" locale="ru-RU" :active="false" />
        </n-statistic>
      </n-ellipsis>
