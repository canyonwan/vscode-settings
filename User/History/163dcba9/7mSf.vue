  ...
  <div class="discretion-tab-panel">
    ...
    <div class="bg-contentBgColor rounded-sm p-5">
      ...
      <n-ellipsis expand-trigger="click" line-clamp="2" :tooltip="false">
        ...
        <div class="text-gray-500 mt-4">系统裁量结果：{{ currentDiscretionResult?.systemMathResult !== NaN || '无' }}</div>
        <div class="text-gray-500 mt-4">自定义裁量计算过程：{{ currentDiscretionResult?.customMathProcess || '暂无' }}</div>
        <div class="text-gray-500 mt-4">自定义裁量结果：{{ currentDiscretionResult?.customMathResult || '无' }}</div>
