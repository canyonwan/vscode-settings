  ...
  <div class="discretion-tab-panel">
    ...
    <div class="bg-contentBgColor rounded-sm p-5">
      ...
      <div class="text-2xl text-blue-500">
        ...
        <n-number-animation class="text text-gray-500" ref="numberAnimationInstRef" show-separator :to="currentDiscretionResult?.systemMathResult" :precision="2" /><span class="text-sm"
          >&nbsp;元</span
        ></div
      >
      <keep-alive>
