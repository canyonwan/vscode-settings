  ...
  <div class="discretion-tab-panel">
    ...
    <div class="bg-contentBgColor rounded-sm p-5">
      ...
      <n-statistic label="处罚金额：" class="mt-2">
        <n-number-animation class="text-sm text-gray-500" ref="numberAnimationInstRef" show-separator :to="currentDiscretionResult?.discretionMoney" :precision="2" locale="ru-RU" />
      </n-statistic>
