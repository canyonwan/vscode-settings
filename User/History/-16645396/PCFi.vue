...
<template>
  <div class="node-leaf">
    ...
    <div v-if="props.itemNode?.childrenList">
      <leaf :item-node="props.itemNode" :idx="props.idx" :parentChildrenLength="props.parentChildrenLength" />
      <!-- 连接线 -->
    ...
    <!-- 最后一层节点 -->
    <leaf v-if="!props.itemNode?.childrenList" :item-node="props.itemNode" :idx="props.idx" :parentChildrenLength="props.parentChildrenLength" />
    <media-preview v-if="!props.itemNode?.childrenList && props.itemNode.fileList.length > 0" class="ml-4 mt-4" :values="props.itemNode.fileList" />
  </div>
</template>
