...
export const schemas = [
  {
    ...
    label: '裁量计算方式',
    componentProps: {
      placeholder: '请输入裁量计算方式',
      options: []
    },
    componentDataSourceType: 'DiscretionCalculateType',
    rules: [{ required: true, type: 'number', message: '裁量计算方式必选', trigger: ['blur', 'change'] }]
  },
  {
    ...
    rules: [{ required: true, type: 'number', message: '裁量类型必选', trigger: ['blur', 'change'] }]
  },
  {
    field: 'baseValue',
    component: 'NInput',
  ...
  },
  {
    ...
    rules: [{ required: true, type: 'number', trigger: 'change', message: '金额下限必填' }]
  },
  {
    field: 'limitMax',
    component: 'NInputNumber',
    ...
    rules: [{ required: true, type: 'number', trigger: 'change', message: '金额上限必填' }]
  },
  {
    field: 'minValue',
    component: 'NInputNumber',
