...
import type {
  ...
  ITimeLineRoot,
  IDeletedIllegalAct,
  ICalcDiscretionResult,
  IEvidenceDataForConfiscateDiscretion
} from './types'
 ...
 * @returns
 */
export function calcDiscretionSum(params: ICalcDiscretionSumFormalParameter): Promise<ICalcDiscretionResult> {
  return http.request({
...
export interface ISaveCustomEvidenceForConfiscateParams {
  evidenceName: string
  causeId: number
  remarks: string
}
 ...
 * @param params caseTypeIdList: 固定罚款id
 */
export function saveCustomEvidenceForConfiscate(params: ISaveCustomEvidenceForConfiscateParams): Promise<ICauseItemForProgram[]> {
  return http.request({
    url: `${serverName}causeEvidence/saveCustomEvidence`,
    method: RequestEnum.POST,
    data: params
  })
}
 ...
 * @param causeId
 */
export function queryEvidenceListForConfiscate(causeId: string): Promise<IEvidenceDataForConfiscateDiscretion> {
  return http.request({
    url: `${serverName}causeEvidence/list/${causeId}`,
    method: RequestEnum.GET
  })
}
 ...
 * 删除(违法行为)
 * @param params proceduresId
 * @param params causeList
 * @returns
 */
export function deleteCause(params: { causeList: { caseTypeId: string; causeId: string }[]; proceduresId: string }): Promise<void> {
  return http.request(
    {
      url: `${serverName}cause/deleteCause`,
      method: RequestEnum.POST,
      data: params
    },
    {
 ...
 * @returns
 */
export function queryDeletedNode(proceduresId: string, type: number): Promise<Array<IDeletedNodeItem | IDeletedIllegalAct>> {
  return http.request({
 ...
 * 回收站恢复
 */
export function restoreWaste(dataId: string[], type: number): Promise<void[]> {
  return http.request(
    {
 ...
 * 回收站节点恢复
 */
export function restoreNodeNameWaste(ids: string[]): Promise<void[]> {
  return http.request(
    {
      url: `${serverName}recycle/recoverTimeNode`,
      method: RequestEnum.PUT,
      data: ids
    },
    {
 ...
 * 回收站证据恢复
 */
export function restoreEvidenceWaste(ids: string[]): Promise<void[]> {
  return http.request(
    {
      url: `${serverName}recycle/recoverEvidence`,
      method: RequestEnum.PUT,
      data: ids
    },
    {
 ...
 * 回收站违法行为恢复
 */
export function restoreIllegalActWaste(proceduresId: string, causeList: { causeId: string; caseTypeId: string }[]): Promise<void[]> {
  return http.request(
    {
      url: `${serverName}recycle/recoverUnlawfulAct`,
      method: RequestEnum.PUT,
      data: { proceduresId, causeList }
    },
    {
      successMessageText: HttpMessageEnum.SUCCESS
    }
 ...
 * @returns
 */
export function permanentlyDelete(ids: string[]): Promise<void> {
  return http.request(
    {
 ...
 *@param params
 */
export function selectTargetForTimeline(params: { targetId: string; procedureId: string; toolGroupId: string; toolId: string; timeLineId: string }): Promise<IInitProceduresInfo> {
  return http.request({
    url: `${serverName}procedures/choiceTarget`,
    method: RequestEnum.PUT,
    data: params
  })
}
