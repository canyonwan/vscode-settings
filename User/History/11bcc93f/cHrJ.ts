 ...
 *@param params
 */
export function selectTargetForTimeline(params: { targetId: string; procedureId: sring; toolGroupId: string; toolId: string; timeLineId: string }): Promise<IInitProceduresInfo> {
  return http.request({
