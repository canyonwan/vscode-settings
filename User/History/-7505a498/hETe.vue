<script setup lang="ts">
  ...
  const emits = defineEmits(['handleSubmitCustomDiscretion', 'cancelModalHandler'])
...
<template>
  <div class="custom-discretion">
    <basic-form @register="register" @submit="onSubmit" @close-modal="() => emits('cancelModalHandler')" />
  </div>
</template>
