...
import type { IMessageItem, IMessageSearch, IMessageSend, IMessageDetail, IAnnouncementSend } from './types'
 ...
 *@param {*参数} params
 */
export function queryAnnouncementDetail(id: number): Promise<IResultPage<IMessageItem[]>> {
  return http.request({
