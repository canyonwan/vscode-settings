      ...
      <n-space vertical>
        ...
        <div class="timeline-item bg-darkPrimary p-6 rounded-lg mr-4">
          <n-space justify="space-between" align="center">
            <!-- <div class="leading-10 px-4 text-center align-middle text-white cursor-pointer bg-e-button-blue-bg bg-no-repeat bg-full">{{ props.itemNode.title }}</div> -->
            <e-button type="orange">
          ...
          <!-- timeline -->
          <n-space>
            <n-space vertical v-for="(timelineNode, index) in props.itemNode.childrenList" :key="timelineNode.id">
              <n-space class="py-5" align="center">
                <n-button text>
                  <template #icon>
