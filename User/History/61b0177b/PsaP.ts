...
const PrimaryCause = defineAsyncComponent(() => import('@/views/cause-library/manage/outdated/components/primary-cause'))
const SubCause = defineAsyncComponent(() => import('@/views/cause-library/manage/components/sub-cause.vue'))
const SaveHandlingWay = defineAsyncComponent(() => import('@/views/cause-library/manage/outdated/components/save-handling-way'))
const SaveGroup = defineAsyncComponent(() => import('@/views/cause-library/manage/outdated/components/save-group'))
const GroupDetailTabs = defineAsyncComponent(() => import('@/views/cause-library/manage/outdated/components/group-details/group-detail-tabs'))
const OrgSelect = defineAsyncComponent(() => import('@/views/user/org-manage/components/org-select.vue'))
const SaveBaseAttrModal = defineAsyncComponent(() => import('@/views/cause-library/manage/outdated/components/group-details/base-attr/save-base-attr'))
