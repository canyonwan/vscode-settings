<template>
  <view class="container">
    ...
    <view class="content">
      <!--轮播图 start-->
      <ad-swiper :img-urls="indexBanner" />
      <!--轮播图 end-->
      <!--搜索 start-->
...
const indexBanner = [
  {
    type: 'image',
    src: 'https://st-gdx.dancf.com/gaodingx/0/uxms/design/20200508-143421-4be9.png?x-oss-process=image/resize,w_600/interlace,1,image/format,webp',
  },
  {
    type: 'image',
    src: 'https://st-gdx.dancf.com/gaodingx/0/uxms/design/20210628-113058-b7d9.gif?x-oss-process=image/format,webp',
  },
]
