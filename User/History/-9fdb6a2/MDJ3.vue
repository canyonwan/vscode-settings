...
export default defineComponent({
  ...
  setup() {
    ...
    const orgInfo = ref<ISelectOrgParams>({ orgId: '', isSameLevel: false, isSubordinate: false, isJustice: true })
    ...
    function onSelect(info: ISelectOrgParams) {
      orgInfo.value = info
      console.log('%c [ orgInfo.value ]-37', 'font-size:13px; background:#0095FF; color:white;', orgInfo.value)
    }

    onMounted(() => {
      currentTab.value = route.path.substring(1)
    })
  ...
  <div class="home">
    ...
    <div class="content">
      ...
      <div class="tabContent">
        ...
        <!-- <KeepAlive include="publicityAfter"> -->
