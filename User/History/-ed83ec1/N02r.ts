...
export const goodsDetailSchemas = <FormSchema[]>[
  ...
  },
  {
    ...
    rules: [{ type: 'number', required: true, message: '请输入商品概述', trigger: ['blur'] }]
  },
  {
    field: 'unitPrice',
    ...
    rules: [{ required: true, message: '请输入当前价格', trigger: ['blur'] }]
  },
  {
    field: 'meteringType',
    component: 'NInputNumber',
  ...
  },
  {
    ...
    rules: [{ required: true, message: '请输入计量值', trigger: ['blur'] }]
  },
  {
