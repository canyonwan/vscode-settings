...
<template>
  <div class="related-program-bar h-full rounded-lg flex flex-col flex-1">
    <div
      class="item text-white font-medium text-center text-sm cursor-pointer rounded-lg h-full justify-center"
