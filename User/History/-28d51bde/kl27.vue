...
<script lang="ts">
  ...
  // import axios from 'axiospdfjs-dist'
  ...
  export default defineComponent({
    ...
    setup(props, { emit }) {
      ...
      function preview(url: string, fileType: number) {
        if (fileType === (FileTypeEnum.Picture || FileTypeEnum.Word || FileTypeEnum.Audio || FileTypeEnum.Video)) {
