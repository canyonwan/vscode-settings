...
<template>
  <div class="save-cause">
    <basic-form @register="register" @submit="onSubmit" @close-modal="() => $emit('onCloseModal')">
      <template #tag>
        <n-form-item ref="formInstRef" label="案由标签" path="displayState.boundCauseTags" :rule="tagRule">
          <n-space vertical>
      ...
      <template #dept>
        <n-form-item ref="formInstRef" label="部门类型" path="displayState.boundDept" :rule="deptRule">
          <n-space vertical>
