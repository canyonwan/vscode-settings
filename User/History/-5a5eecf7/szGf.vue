...
<template>
  <n-card class="app-package-home">
    <basic-table :request="loadTableData" ref="tableRef" :columns="tableColumns" :action-column="actionColumn" :scroll-x="1600" :row-key="(row: IAppPackageItem) => row.id ">
      <template #tableTitle>
