...
import type { IAppPackageItem, IAppVersionDetail, IBoundOrg } from './types'
 ...
 *@param {*参数} appId
 */
export function queryAppVersionDetail(appId: string): Promise<IAppVersionDetail> {
  return http.request({
 ...
 *@param  appId
 */
export function queryBoundDeptForApp(appId: string): Promise<{ id: string; name: string }[]> {
  return http.request({
 ...
 *@param  appId
 */
export function queryBoundOrgForApp(appId: string): Promise<IBoundOrg[]> {
  return http.request({
 ...
 *@param {*参数} params
 */
export function queryBindDeptForApp(params: { appId: string; idList: string[] }): Promise<void> {
  return http.request(
    {
 ...
 *@param {*参数} params
 */
export function queryBindOrgForApp(params: { appId: string; idList: string[] }): Promise<void> {
  return http.request(
    {
