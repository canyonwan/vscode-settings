...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const createActions = (record: any) => {
      return [
        {
          frontEndIdentification: ['b01_03_01'],
          type: 'info',
          label: '编辑',
          onClick: editMenu.bind(null, record)
        },
        {
          frontEndIdentification: ['b01_03_02'],
          type: 'error',
          label: '删除',
    ...
    const okSaveEvidenceMenuHandler = () => {
      reloadTable(state.evidenceMenuItem.id ? {} : { page: 1 })
      closeModal()
    }
      ...
      <div>
        ...
        >
          {{
            ...
            toolbar: ({ disabled }) =>
              props.useSelection || (
                <NButton type="success" onClick={() => addEvidenceMenu('0')} disabled={disabled}>
                  新增证据清单
                </NButton>
              )
          }}
