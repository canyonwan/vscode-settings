  ...
  export default defineComponent({
    ...
    setup(props, { emit }) {
      ...
      function beforeUpload({ file }) {
        ...
        console.log('%c [ fileInfo ]-170', 'font-size:13px; background:#0095FF; color:white;', fileInfo)
      ...
      function finish({ event: Event }) {
        ...
        console.log('%c [ res ]-210', 'font-size:13px; background:#0095FF; color:white;', res)
        console.log('%c [ result ]-212', 'font-size:13px; background:#0095FF; color:white;', result)
        //成功
