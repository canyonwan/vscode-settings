...
export default defineComponent({
  ...
  setup(props) {
    ...
    watchEffect(() => getEvidenceMenuList())
    ...
    return () => (
      <>
        ...
        ></NDataTable> */}
        <BasicTable row-key={(row: IEvidenceGroupType) => row.id} v-model:checkedRowKeys={state.checkedKeys} request={getEvidenceMenuList} columns={boundMenuTableColumns} scroll-x={1800}></BasicTable>
