  ...
  setup(props) {
    ...
    return () => (
      <>
        ...
        ></NDataTable> */}
        <BasicTable row-key={(row: any) => row.id} request={async () => await queryBoundMenusWithEvidenceGroup(props.evidenceGroupItem.id!)} columns={tableColumns} scroll-x={1800}></BasicTable>
