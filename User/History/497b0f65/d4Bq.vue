...
<template>
  <div class="timeline-item p-4 ml-12 mr-4 mb-6">
    ...
    <n-popover trigger="hover">
      <template #trigger>
        <div class="e-button flex items-center justify-between text-sm cursor-pointer" :class="{ 'mb-6': props.itemNode.toolType !== 8 }" @click="handleClick(props.itemNode)">
          <div class="pr-4">
    ...
    <evidence-leaf v-if="props.itemNode.toolType === 8" :children="props.itemNode.childrenList" />
