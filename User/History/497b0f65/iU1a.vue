  ...
  <div class="timeline-item p-4 ml-12 mr-4 mb-6">
    ...
    <div class="flex">
      <div class="flex flex-col px-2" v-for="(timelineNode, idx) in props.itemNode.childrenList" :key="timelineNode.id">
        <node-leaf v-if="timelineNode.toolType !== 8" :item-node="timelineNode" :idx="idx" :parentChildrenLength="props.itemNode.childrenList.length" />
        <evidence-leaf v-else :children="timelineNode.childrenList" />
      </div>
    </div>
