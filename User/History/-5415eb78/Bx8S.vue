<script setup lang="ts">
  ...
  function echoCalcMoneyState() {
    multiply(item.operatorValue!, 100)
    console.log('%c [ multiply(item.operatorValue!, 100) ]-170', 'font-size:13px; background:#0095FF; color:white;', multiply(item.operatorValue!, 100))
