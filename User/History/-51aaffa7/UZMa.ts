...
import { FileInfo } from '../upload/types'
...
export interface IToolInfo {
  ...
  typeIdName: string
  renderTypeIds: string[] | null // 渲染类型（多选）
  setDataExpressions: IAssignMethod[] | [] // 赋值表达式 工具有  必填
  appIconFileId: string | null // app工具图标文件id
  appIconFileInfo: FileInfo | null // app工具图标文件对象
  webIconFileId: string | null // web工具图标文件id
  webIconFileInfo: FileInfo | null // web工具图标文件对象
  abbreviation: string // 简称(工具名字过长的简称)
}
...
export interface IToolInfoExpress {
  ...
  webIconFileId: string | null // web工具图标文件id
  webIconFileInfo: IFileItem // web工具图标文件对象
  webIconFileName: string
}
// 赋值表达式
