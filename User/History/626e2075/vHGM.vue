...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    function onSwitch(item: IAction) {
      console.log('%c [ item ]-18', 'font-size:13px; background:#0095FF; color:white;', item)
      console.log('%c [ actions ]-18', 'font-size:13px; background:#0095FF; color:white;', props.data)
    ...
    watch(
      ...
      () => {
        ...
        console.log('%c [ actions vue ]-23', 'font-size:13px; background:#0095FF; color:white;', props.data)
      },
      { immediate: true }
    )
