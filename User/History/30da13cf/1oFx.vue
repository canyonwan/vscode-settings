<script setup lang="ts">
  ...
  import { deleteSubCause, queryCauseManageList, causeBindCauseType, queryBoundCauseType } from '@/api/cause-manage/cause-manage'
  ...
  async function getBoundCauseTypes(id: string) {
    const res = await queryBoundCauseType(id)
