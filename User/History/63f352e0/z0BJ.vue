<script setup lang="ts">
  ...
  import { PrivacyTipSharp } from '@vicons/material'
    ...
    <n-card class="cause-browse">
      ...
      <div class="grid grid-cols-3 gap-6">
        ...
        <template v-if="searchState.causeSubTagIdList.length === 0">
          <div class="tree-box col-span-2 flex justify-center items-center"><n-icon class="mr-2" size="20" :component="PrivacyTipSharp" color="#4084CC" /> 请先在左侧列表选择违法行为</div>
        </template>
