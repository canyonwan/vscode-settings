    ...
    <n-card class="cause-browse">
      ...
      <div v-else class="grid grid-cols-3 gap-6">
        ...
        <template v-if="searchState.causeSubTagIdList.length === 0">
          <div class="col-span-2 flex justify-center items-center">请先在左侧列表选择违法行为</div>
        </template>
        <unlawful-act-detail v-else class="tree-box col-span-2 items-center" :cause-tag-ids="searchState.causeSubTagIdList" :allow-select="props.allowSelect" @onSubmit="submitHandler" />
      </div>
    </n-card>
