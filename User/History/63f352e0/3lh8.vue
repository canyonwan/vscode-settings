  ...
  <div>
    <n-card class="cause-browse">
      ...
      <template v-if="treeData?.length === 0">
        <n-empty style="min-height: 400px" class="justify-center" description="暂无数据" />
      </template>
      <div v-else class="grid grid-cols-3 gap-6">
        ...
        <!-- <unlawful-act-detail class="tree-box col-span-2" :cause-tag-ids="searchState.causeSubTagIdList" :allow-select="props.allowSelect" @onSubmit="submitHandler" /> -->
        <unlawful-act-detail class="tree-box col-span-2" :cause-tag-ids="searchState.causeSubTagIdList" allow-select @onSubmit="submitHandler" />
      </div>
    </n-card>
