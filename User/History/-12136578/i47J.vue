...
<script setup lang="ts">
  ...
  import { reactive, ref, h, watchEffect, useSlots, useAttrs } from 'vue'
  ...
  <div>
    <n-card>
      <basic-table
        ...
        single-line
        single-column
        :action-column="$props.actionColumn || actionColumn"
        scroll-x="1090"
      >
    ...
    <basic-modal @register="modalRegister" style="width: 70%">
      <component :is="currentComp" :current-row-data="state.currentRowData" @submit-handler="submitHandler" />
    </basic-modal>
