<template>
  <div class="menu-table-list">
    <basic-table :row-key="(row: IDiscretionMenuType) => row.id" :request="props.loadTableData" :pagination="false" ref="tableRef" :columns="tableColumns" :action-column="{}" :scroll-x="1800">
