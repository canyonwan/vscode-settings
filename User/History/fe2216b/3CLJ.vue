<script setup lang="ts">
  ...
  defineProps<{ children: ITimeLineTreeLeaf[] }>()
</script>
<template>
  <div class="flex flex-col items-center" v-for="child in children" :key="child.id">
    <!-- 未开始 -->
    ...
    <media-preview class="ml-4 mt-4" :values="child.fileList" />
  </div>
</template>
