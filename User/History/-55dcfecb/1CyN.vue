<script setup lang="ts">
  ...
  import { punishSchemas } from './schemas'
...
<template>
  <div class="punish">
    ...
    <basic-table :row-key="(row: IProgramItem) => row.id" :request="loadTableData" ref="tableRef" :columns="punishColumns" :action-column="actionColumn" scroll-x="1090" :single-line="false" />
