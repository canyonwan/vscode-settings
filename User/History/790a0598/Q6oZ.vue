            ...
            <div v-if="tool && tool.currentPermissionsIsRelease && judgeExpress(tool, 1)">
              ...
              <div
                ...
                :class="[
                  ...
                  !isDisabled && !group.disabled && judgeExpress(tool, 2) ? 'action-button pointer-events-auto' : 'text-textColorDisable border rounded-lg border-dark-100 pointer-events-none'
                ]"
              >
