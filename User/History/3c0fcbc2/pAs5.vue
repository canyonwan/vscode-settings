<script setup lang="ts">
  ...
  import { handOverSchemas } from './schemas'
  import { handOverColumns } from './columns'
...
<template>
  <div class="hand-over">
    ...
    <basic-table :row-key="(row: IProgramItem) => row.id" :request="loadTableData" ref="tableRef" :columns="handOverColumns" :action-column="actionColumn" scroll-x="1090" :single-line="false" />
