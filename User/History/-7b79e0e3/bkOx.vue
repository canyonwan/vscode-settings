...
<template>
  <div ref="itemEl">
    <n-space align="center">
      <!-- content -->
      <n-space vertical>
        <n-divider dashed title-placement="left" style="height: 20px; background-color;: #06306f">
        ...
        <div class="timeline-item bg-darkPrimary p-4 rounded-md mr-4">
          ...
          <!-- 递归timeline -->
          <n-space>
            <n-space vertical v-for="(timelineNode, idx) in props.itemNode.childrenList" :key="timelineNode.id">
              <node-leaf :item-node="timelineNode" :idx="idx" />
            </n-space>
          </n-space>
        </div>
      </n-space>
