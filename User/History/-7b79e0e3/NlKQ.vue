<script setup lang="ts">
  ...
  onMounted(() => {
    if ([4, 7, 9, 5, 6].includes(props.itemNode.toolType)) {
      dropdownMenuOptions.value = dropDownMenuOriginal.slice(1, 2)
      console.log('%c [ dropdownMenuOptions.value ]-126', 'font-size:13px; background:pink; color:#bf2c9f;', dropdownMenuOptions.value)
    }
  })
</script>
