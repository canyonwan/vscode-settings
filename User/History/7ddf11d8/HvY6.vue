...
<template>
  <div class="discretion-tab-panel">
    ...
    <div class="bg-contentBgColor rounded-sm p-5">
      ...
      <div>处罚金额: {{ state.discretionResult.discretionMoney }}</div>
      <n-number-animation ref="numberAnimationInstRef" :from="0.0" :to="699700.699" :active="false" :precision="3" locale="ru-RU" show-separator />
      <component
