...
<template>
  <div class="discretion-tab-panel">
    ...
    <div class="bg-contentBgColor rounded-sm p-5">
      ...
      <div>处罚金额: </div>
      <!-- <component :is="props.currentStep === 1 ? DType : DMenu" :programCauseId="props.programCauseId" /> -->
      <d-type v-if="props.currentStep === 1" />
      <d-menu v-else :programCauseId="props.programCauseId" />
    </div>
  </div>
</template>
