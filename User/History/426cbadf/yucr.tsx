...
import type { ICommonBindParameterType, IDiscretionMenuType } from '@/api/cause-manage/types'
...
export default defineComponent({
  ...
  setup() {
    ...
    const loadTable = async () => {
      ...
      // console.log('boundKeys', state.boundKeys)
      state.boundKeys = recursiveSelectedIds(res)
      console.log('state boundkeys', state.boundKeys)
      return res
    }

    function recursiveSelectedIds(res: IDiscretionMenuType[]) {
      const arr: string[] = []
