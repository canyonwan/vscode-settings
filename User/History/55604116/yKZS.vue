<script setup lang="ts">
  ...
  function filterData() {
    ...
    console.log('%c [ value ]-15', 'font-size:13px; background:#0095FF; color:white;', state.value)
  }
...
<template>
  <div class="base-attr">
    <n-card title="违法理由" class="mb-4" hoverable>
      <template v-if="!state || state['1000000']?.length === 0">
